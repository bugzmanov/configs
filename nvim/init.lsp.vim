" This is a config that set-ups lsp based env for rust heavily based on https://github.com/jonhoo/configs/tree/master/editor/.config/nvim
...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap('n', '<space>np', '<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>', opts)
...
let g:lightline = {
      \ 'active': {
      \   'left': [ [ 'lsp_info', 'lsp_hints', 'lsp_errors', 'lsp_warnings', 'lsp_ok' ], [ 'lsp_status' ], [ 'mode', 'paste'],
...
" serch for visually selected item
